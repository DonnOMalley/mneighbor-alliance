...
The Block Community Network operates on two tiers to keep leadership lightweight and distributed:
...
*   **Managing Block Leaders:** Recruiting, onboarding, and supporting a volunteer Block Leader for each individual block within the Link boundary.
...
*   **Vacancy Coverage:** If a block has no active Block Leader, the Router temporarily covers that block's communication duties until a replacement is recruited.
...
| **National Night Out** | Annual (1st Tuesday of August) | Organize or support a casual block gathering for National Night Out. This can be as simple as a shared cooler of drinks on someone's front lawn. |
...
| Element | Detail |
| :--- | :--- |
| **Cadence** | Monthly, on a fixed day (recommended: 3rd Monday or 3rd Wednesday of each month). |
...
| **Facilitation** | Rotates monthly between willing attendees. The Router or a Block Leader can anchor facilitation until the group is self-sustaining. |
...
2. CITY & POLICE LIAISON UPDATE (5 min)
   - Any updates from the SPPD Western District or city council
   - Relevant crime alerts or patterns shared by the district
...
4. ACTION ITEMS & NEXT MEETING (5 min)
   - Who is doing what before next month
...
*   **Urgent safety alerts** (active incidents, immediate hazards) bypass the monthly meeting and go directly to the Signal group and porch-to-porch relay by Block Leaders.
*   **City reporting:** Residents are encouraged to report issues directly to the City of Saint Paul via the Citizen Service Line (**651-266-8989**) or the online incident reporting form. The committee does not replace official reporting channels.
...
| **August** (1st Tuesday) | National Night Out | Medium | Casual front-yard or porch gathering. Can be as simple as a shared cooler and lawn chairs. Register with the city's NNO program if desired. |
| **Fall** (Sep-Oct) | Seasonal Check-In & Harvest | Low | Walk the block. Share info on any fall events. If a community garden is active, coordinate a harvest share or seed swap. |
...
### Vacancy Protocol
If a block within the Link boundary has no Block Leader:
1.  The Router covers that block's flyer drops and welcome visits temporarily.
2.  The Router asks existing Block Leaders if they know anyone on the vacant block.
3.  If a block remains vacant for more than 6 months, the Router flags it at the next Mesh Council roundtable for cross-Link outreach support.

---

## 6. Relationship to Existing MNA Documents
