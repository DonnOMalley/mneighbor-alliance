...
| :--- | :--- | :--- |
| **Flyer Drops** | As needed (typically 4-6x/year) | Walk the block and drop event flyers, petition QR sheets, or community updates on every porch. |
| **Welcome Visits** | Within 2 weeks of a new move-in | Deliver a brief porch visit to new neighbors with an info sheet (see Section 2 below). |
| **Block Party / Street Closure or Porch Gathering** | Annual (1st Tuesday of August) | Organize or support a block gathering, scaled to the block — see Section 4. |
...
**Back Side — "Quick References"**
*   MNeighbor Alliance website or contact info.
*   City of Saint Paul non-emergency line: **651-266-8989**.
*   Western District Police non-emergency: **651-266-5512**.
*   Ramsey County recycling and composting schedule link.
...
## 3. Crime & Safety Committee

Neighborhood safety works best when it is proactive, recurring, and face-to-face. The Block Community Network includes a standing **Crime & Safety Committee** that provides a regular forum for residents to share concerns, hear updates, and coordinate with each other.

> [!WARNING]
> **Operating Limits & Legal Guardrail:**
> The Crime & Safety Committee is a communication forum, not an enforcement body. Committee members do not conduct patrols, enforce rules, confront individuals, or act as agents of law enforcement. The committee does not collect, store, or distribute personal information about individuals suspected of criminal activity. All safety concerns involving criminal behavior must be reported to the Saint Paul Police Department.

### Structure

| Element | Detail |
| :--- | :--- |
| **Cadence** | Quarterly, on a fixed day (recommended: 3rd Monday or 3rd Wednesday of the first month of each quarter). If a specific concern needs faster turnaround or direct action, a smaller ad hoc functional group can organize around that issue and disband once the root issue is addressed — see note below. |
...
1. BLOCK-BY-BLOCK CHECK-IN (10 min)
   ...
   - Infrastructure concerns (broken streetlights, potholes)

2. CITY & POLICE MONITORING UPDATE (5 min)
   - Community-sourced updates on SPPD Western District activity,
     city council actions, or public safety announcements
   - Relevant crime alerts or patterns residents have observed or
     found through public reporting

3. OPEN DISCUSSION (10-15 min)
   - Resident concerns not covered above
   - Coordination on specific issues (e.g., organizing a
     porch-light campaign, sharing security camera footage
     protocols, planning a community walk)

4. ACTION ITEMS & NEXT MEETING (5 min)
   - Who is doing what before next quarter
   - Confirm next meeting date, location, and facilitator
```

> **On "monitoring" vs. "liaising":** This committee reports on and monitors police and city activity — it is not a liaison to, or a trusted partner of, any outside organization by default. We may interact with SPPD or the city when it's useful, but that's a separate process from this committee vouching for or representing residents to an organization the committee hasn't chosen to trust.
...
| :--- | :--- | :--- | :--- |
| **Early Spring** (Mar-Apr) | Spring Clean-Up | Medium | Coordinate a block litter walk. Bags and gloves from the city or purchased from the community chest. Combine with a coffee/cocoa station on someone's porch. |
| **Late Spring** (May) | Welcome Visits | Low | Walk the block and visit any households that moved in over the winter. Drop the Welcome Info Sheet. |
| **Early Summer** (Jun) | Flyer Drop — Summer Events | Low | Distribute the season's event flyers (block party date, concert series, community garden openings). |
| **Mid-Summer** (Jul-Aug) | Block Party / Street Closure | High | The signature permitted street event run through the [Event Playbook](EVENT_PLAYBOOK.md). |
| **August** (1st Tuesday) | Block Party / Street Closure — or Casual Porch Gathering | Medium–High | Scale to what the block can actually support: a full permitted street closure (see the [Event Playbook](EVENT_PLAYBOOK.md)) if there's the volunteer capacity for it, or a simple casual front-yard/porch gathering — a shared cooler and lawn chairs is enough — if not. Register with the city's National Night Out program either way if desired. |
| **Fall** (Sep-Oct) | Seasonal Check-In, Harvest & Halloween | Low–Medium | Walk the block. Share info on any fall events. If a community garden is active, coordinate a harvest share or seed swap. Cap the season with a Halloween gathering — porch trick-or-treat coordination, a decorating contest, or a shared candy/cider station. For a lot of blocks this is the last outdoor touchpoint of the year before everyone retreats to the warmth of home for winter. |
...
## 5. Mutual Aid Baseline: Shoveling, Wellness Checks, Resource Sharing & Emergency Alerts

Neighbors already ask for and offer this kind of help informally. This section gives every block the same simple baseline for doing it — through the Signal group the block already uses — so nobody has to reinvent the process, while leaving room for a block to build something more elaborate if it wants to.

### Baseline Process (Use This Unless Your Block Has Something Better)
1.  **Post in the block Signal group** using a simple tag prefix so requests are easy to scan:
    *   `[SHOVEL]` — snow shoveling or mowing help needed or offered.
    *   `[CHECK]` — a wellness check requested for a specific neighbor or address.
...
### Room to Grow
This baseline is intentionally minimal so every block can adopt it without extra setup. Blocks that want more structure can layer on things like a shared spreadsheet of standing offers (snowblower, ladder, etc.), a rotating on-call list for wellness checks, or a seasonal supply exchange — none of that is required to start.
...
## 7. Relationship to Existing MNA Documents
