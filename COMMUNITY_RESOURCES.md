...
*   **Snow Emergency Alerts:** Sign up for text/email alerts at [stpaul.gov/snow](https://www.stpaul.gov/snow).
*   **Winter Parking Rules:** During a declared snow emergency, vehicles must be moved off designated routes or face ticketing/towing. Check the city site for your street's designation.

---

## 2. City Services & Utilities
...
### Utilities
*   **Saint Paul Regional Water Services:** 651-266-6350 — Water billing, service, and water quality reports.
*   **Xcel Energy (Electric & Gas):** 1-800-895-4999 — Outage reporting, billing, energy assistance programs.
*   **CenterPoint Energy (Gas, if applicable):** 612-372-4727
...
Resources for residents who choose to remain in their homes as they age, rather than moving to assisted living.
...
## 5. Local Organizations & Mutual Aid
...
### Food Access
*   **Ramsey County Food Resources:** Food shelves, meal programs, and SNAP assistance. [ramseycounty.us/residents/assistance-support/food-support](https://www.ramseycounty.us/residents/assistance-support/food-support)
*   **Keystone Community Services:** Food shelf locations in Saint Paul with no income verification required. [keystoneservices.org](https://www.keystoneservices.org)

### Tools & Making
*   **Saint Paul Tool Library:** Borrow tools for home repair, gardening, and building projects instead of buying. | [saintpaultoollibrary.org](https://www.saintpaultoollibrary.org)
*   **Maker Spaces:** For neighbors interested in the [Electronics & Tinkering Club](ELECTRONICS_TINKERING_CLUB_PLAN.md), local maker spaces offer shared equipment, training, and workshop space.
...
### Nearby Parks
*   **Midway Peace Park** — 416 North Griggs Street. Open green space, community events, partner location for Movie in the Park and Yoga programming.
*   **Dunning Recreation Center** — 1221 Marshall Avenue. Indoor facility with gym, activity rooms, and rec programming. Available for community events.

### Saint Paul Parks & Recreation
*   **General Info:** [stpaul.gov/parks](https://www.stpaul.gov/parks)
*   **Facility Reservations:** Reserve park shelters, fields, and rooms for Link events. Check availability at [stpaul.gov/reservations](https://www.stpaul.gov/facilities/reservations).
*   **Community Gardens:** Contact Parks & Rec for plots and garden program info.
...
| Service | Details |
| :--- | :--- |
| **Metro Transit (Bus & Light Rail)** | Route planning, schedules, and fare info: [metrotransit.org](https://www.metrotransit.org). The A Line (rapid bus on Snelling) and Route 21 (Selby/Lake) serve the Selbtoria area. |
| **Nice Ride (Bike Share)** | Station-based bike sharing. Find stations and pricing at [niceridemn.com](https://www.niceridemn.com). |
| **Biking Resources** | Saint Paul bike maps, trail info, and bike rack requests: [stpaul.gov/biking](https://www.stpaul.gov/biking). |
| **Scooter Regulations** | E-scooter rules, parking requirements, and complaint reporting: [stpaul.gov/scooters](https://www.stpaul.gov/scooters). |

---

## 8. Saint Paul Public Libraries

Libraries are a core piece of MNA infrastructure — free meeting rooms for [Community Clubs](COMMUNITY_CLUBS.md), [Crime & Safety Committee](BLOCK_NETWORK.md#3-crime--safety-committee) meetings, and [Build Nights](ELECTRONICS_TINKERING_CLUB_PLAN.md).

*   **Central Library** — 90 West Fourth Street, 651-266-7000
*   **Hamline Midway Library** — 1558 West Minnehaha Avenue, 651-642-0293
*   **Merriam Park Library** — 1831 Marshall Avenue, 651-642-0385
*   **Reserve meeting rooms:** [sppl.org/meeting-rooms](https://www.sppl.org/meeting-rooms)

---

> [!NOTE]
> **Disclaimer:** MNeighbor Alliance does not endorse, guarantee, or assume responsibility for any external organizations, services, or resources listed in this directory. All contact information and URLs are provided as a convenience and should be independently verified. Residents are responsible for evaluating the suitability of any service for their individual needs.
